...
const _TABLENAME = 'periods'

export class PeriodModel extends Timestampable {
...
export type Period = ModelObject<PeriodModel>;

export default function (app: Application): typeof PeriodModel {
